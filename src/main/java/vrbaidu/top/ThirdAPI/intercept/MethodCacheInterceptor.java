package vrbaidu.top.ThirdAPI.intercept;

import org.aopalliance.intercept.MethodInterceptor;
import org.aopalliance.intercept.MethodInvocation;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import vrbaidu.top.util.RedisUtil;
        ...
        try {
            ...
            if (value != null) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        if (tkey.startsWith("vrbaidu.top.xxxx.service.impl")) {
                            redisUtil.set(tkey, tvalue, xxxRecordManagerTime);
                        } else if (tkey.startsWith("vrbaidu.top.xxxx.service.impl")) {
