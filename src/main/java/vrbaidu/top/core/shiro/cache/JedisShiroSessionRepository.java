package vrbaidu.top.core.shiro.cache;

import org.apache.shiro.session.Session;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import vrbaidu.top.core.shiro.session.CustomSessionManager;
import vrbaidu.top.core.shiro.session.SessionStatus;
import vrbaidu.top.core.shiro.session.ShiroSessionRepository;
import vrbaidu.top.util.SerializeUtil;
...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
    ...
    public void saveSession(Session session) {
        ...
        try {
        	...
        	logger.error("save session error，id:[%s]",session.getId(), getClass(), e);
        }
    }
    ...
    public void deleteSession(Serializable id) {
        ...
        try {
        	...
        	logger.error("删除session出现异常，id:[%s]", id, getClass(), e);
        }
    }
    ...
    public Session getSession(Serializable id) {
        ...
        try {
        	...
        	logger.error("获取session异常，id:[%s]", id, getClass(), e);
        }
        return session;
    }
    ...
    public Collection<Session> getAllSessions() {
		...
		try {
			...
			logger.error("获取全部session异常", getClass(), e);
		}
