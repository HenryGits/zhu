package vrbaidu.top.core.shiro.service.impl;
...
import vrbaidu.top.core.config.INI4j;
import vrbaidu.top.core.shiro.service.ShiroManager;
...
public class ShiroManagerImpl implements ShiroManager {
	...
	private String getFixedAuthRule(){
		...
		try {
			...
			logger.error("加载文件出错。file:[%s]", fileName, e);
		}
