package vrbaidu.top.api.intercept;

import org.aopalliance.intercept.MethodInterceptor;
import org.aopalliance.intercept.MethodInvocation;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import vrbaidu.top.redisCache.service.impl.RedisCachService;
...
public class MethodCacheInterceptor implements MethodInterceptor {
    ...
    private RedisCachService redisUtil;
        ...
        try {
            ...
            if (value != null) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        int str = tkey.indexOf("service.impl");
                        if (str != 0) {
    ...
    public void setRedisUtil(RedisCachService redisUtil) {
